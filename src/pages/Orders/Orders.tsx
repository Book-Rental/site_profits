                            ...
                            <div className="flex flex-col items-center justify-between gap-4 border-t border-slate-100 px-4 py-4 sm:flex-row sm:px-6">
                                ...
                                <div className="flex max-w-full items-center gap-1 overflow-x-auto">
                                    ...
                                    <button
                                        ...
                                        className="flex h-9 shrink-0 items-center gap-1 rounded-lg border border-slate-200 px-3 text-sm font-medium text-slate-600 transition hover:bg-slate-50 disabled:cursor-not-allowed disabled:opacity-40"
                                    >
                                        <ChevronLeft size={16} />
                                            ...
                                            (pageNumber, index) => {
                                                ...
                                                return (
                                                    <button
                                                        ...
                                                        className={`flex h-9 min-w-9 shrink-0 items-center justify-center rounded-lg px-2 text-sm font-medium transition ${page === pageNumber
                                    ...
                                    <button
                                        ...
                                        className="flex h-9 shrink-0 items-center gap-1 rounded-lg bg-blue-600 px-3 text-sm font-medium text-white transition hover:bg-slate-800 disabled:cursor-not-allowed disabled:opacity-40"
                                    >
                                        <span className="hidden sm:inline">
                                            Next
                                        </span>
